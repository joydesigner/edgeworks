(function($) {
    ...
    function map() {
        ...
        var myLatLng = new google.maps.LatLng(-37.821145, 144.963311);
        var mapProp = {
            center: myLatLng,
            zoom: 10,
            scrollwheel: false,
    ...
    ==========================================================================*/
        $(window).on('load', function() {
            ...
            if ($(".default-scroll").length) {
                smoothScrolling($("#navbar > ul > li > a:not(.dropdown-toggle)"), 80);
            }

            // App landing home smooth scrolling
            if ($(".home-app-landing").length) {
                smoothScrolling($(".scroll-pointer > ul > li > a:not(.dropdown-toggle)"), 0);
